  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
        <img alt="kg" class="img-fluid" src="img/IMG-20221208-WA0001.jpg" />
      </div>
        ...
        <div class="row g-3 mb-4">
          <div class="col-12 d-flex">
            ...
            <div class="ms-4">
              ...
              <span
                >We help recycle used plastic in order to reduce the
                environmental damage of plastic.</span
              >
            </div>
          </div>
          <div class="col-12 d-flex">
            ...
            <div class="ms-4">
              ...
              <span
                >Saving the environment is at the top of our priority and we are
                reaching out to you help us accomplish this goal.
              </span>
            </div>
          </div>
        </div>
