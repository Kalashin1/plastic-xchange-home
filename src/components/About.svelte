  ...
  <div class="container">
    <div class="row g-5 align-items-center">
      <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
        <img alt="kg" class="img-fluid" src="img/about.png" />
      </div>
      <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h2 class="mb-4">
          Plastic Exchange is a campaign designed by E-SCHOLAR Nigeria
        ...
        <p class="mb-4">
          ...
          up local water ways and eventually in oceans and seas. The campaign
          also intends to show the economic benefits of engaging in the
          recycling of plastic waste locally in the environment. Finally the
          project shows a positive correlation between the recycling of plastic
          products and the reduction of carbon emissions into air caused by the
          ...
          is reinforced and adhered to by various social groups there would be a
          systematic reduction in the production of new plastic materials by
        ...
        <div class="row g-3 mb-4">
          <div class="col-12 d-flex">
            ...
            <div class="ms-4">
              <h6>Plastic Recycling</h6>
              <span
                >We help recycle used plastic in order to reduce the environmental damage of plastic.</span
              >
            </div>
          </div>
          <div class="col-12 d-flex">
            <div class="flex-shrink-0 btn-lg-square rounded-circle bg-primary">
              <i class="fa fa-chart-line text-white" />
            </div>
            <div class="ms-4">
              <h6>Environmental Protection</h6>
              <span
                >Saving the environment is at the top of our priority and we are reaching out to you help us accomplish this goal. </span
              >
            </div>
          </div>
        </div>
